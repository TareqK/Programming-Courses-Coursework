...
set_menu_format(my_menu3, 0,4);//formating the menu
	...
	my_win1 =newwin(7,80,0,0);
        keypad(my_win1, TRUE);
       my_win2=newwin(7,80,7,0);
       keypad(my_win2 ,TRUE);
      my_win3=newwin(7,80,14,0);
       keypad(my_win3 ,TRUE);
      
	
	/* Set main window and sub window */
        set_menu_win(my_menu, my_win1);
        set_menu_sub(my_menu, derwin(my_win1, 5, 80,1 , 0));
         set_menu_mark(my_menu, " * ");
         
       
        set_menu_win(my_menu2,my_win2);
        set_menu_sub(my_menu2, derwin(my_win2,5, 80,1 , 0));
        set_menu_mark(my_menu2, " * ");
        
        set_menu_win(my_menu3,my_win3);
        set_menu_sub(my_menu3,derwin(my_win3,5, 80,1 , 0));
