...
\addcontentsline{toc}{section}{Version Histroy}
  \vhEntry{1.0}{30.07.17}{TK|AS|DAS|AB}{Created}
  \vhEntry{1.1}{12.08.17}{AS}{Fixed use case diagram}
  \vhEntry{1.1}{12.08.17}{TK}{Added use case specification for "Give Perscription" and "Report to Doctor"}
  \vhEntry{1.1}{12.08.17}{TK}{Changed order of "Use Cases" subsections}
\end{versionhistory}
\newpage
