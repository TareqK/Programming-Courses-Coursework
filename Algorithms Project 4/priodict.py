...
# Updated and Tweaked Slightly by
# Tareq Kirresh,BZU,14 April 2017
# This is effectively the Data structure known as a 
# HeapMap, Which is a combination of a 
# Priority Queue and a HashTable. This was used
# for the purpouses of creating a Dijkstra Tree
# from a Graph, Since this Data structure is
# Time effecient enough at Olog(n) , But easy 
# Enough to Use to producde Readable Code.
